...
enum TypoChecker {
    ...
    static func hasLikelyTypo(in text: String) -> Bool {
        ...
        while searchStart < nsText.length {
            ...
            if looksLikeTypo(word) { return true }
    ...
    static func autoFixed(_ text: String) -> String {
        let checker = NSSpellChecker.shared
        let nsText = text as NSString
    ...
    private static func looksLikeTypo(_ word: String) -> Bool {
        ...
        if allowedShorthand.contains(word.lowercased()) { return false }
        return true
    }
}
